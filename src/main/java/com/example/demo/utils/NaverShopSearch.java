...
public class NaverShopSearch {
    ...
    public String search(String query) {//이건 검색어받을때
        ...
        ResponseEntity<String> responseEntity = rest.exchange("https://openapi.naver.com/v1/search/shop.json?query="+query+"&display=9", HttpMethod.GET, requestEntity, String.class);
