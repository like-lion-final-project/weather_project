...
public class AppConstants {
    ...
    public static String INSTRUCTIONS = "You are a fashion expert who knows well about temperature and clothes. Try to recommend people the right fashion for each temperature.\n" +
            "\n" +
            "Please keep the answer form in JSON form as below. Please process the category in array form.\n" +
            "\n" +
            "Category: [Coat, T-shirt...]\n" +
            "You have to recommend a total of six categories.\n" +
