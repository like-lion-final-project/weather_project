...
//                    case "completed":
//                        MessageList getMessagesResDto = gptAssistantService.getMessagesAPI(runs.getThreadId());
//                        Message getMessageResDto = gptAssistantService.getMessageAPI(runs.getThreadId(), getMessagesResDto.getFirstId());
